...
var EventIcons = map[events.EventType]string{
	...
	events.EventPregnancy:            "P",
	events.EventDeathNatural:         "X",
	events.EventDeathAccident:        "X",
	events.EventDeathMurder:          "X",
	events.EventSuicide:              "X",
	events.EventIllnessOnset:         "+",
	events.EventRecovery:             "+",
	events.EventMentalBreakdown:      "!",
	events.EventRevelation:           "?",
	events.EventDecisionPoint:        "?",
	events.EventSexualEncounter:      "L",
	events.EventKinkDiscovery:        "L",
	events.EventAffairStart:          "L",
	events.EventAffairEnd:            "l",
	...
	events.EventWarDeclaration:       "W",
	events.EventPeaceTreaty:          "=",
	events.EventMarriage:             "&",
	events.EventDivorce:              "/",
	events.EventAdoption:             "A",
	events.EventBetrayalRevealed:     "!",
	events.EventForgiveness:          "O",
	events.EventExile:                ">",
	events.EventRumourSpread:         "~",
	events.EventGossipChain:          "~",
	events.EventPublicHumiliation:    "#",
	events.EventParty:                "*",
	events.EventFuneral:              "X",
	events.EventRitual:               "R",
	events.EventReligionFounded:      "R",
	events.EventElection:             "V",
	events.EventCoup:                 "!",
	...
	events.EventDrought:              "!",
	events.EventPlague:               "!",
	events.EventIslandDiscovery:      "I",
	events.EventResourceDepletion:    "$",
	events.EventTechDiscovered:       "T",
	events.EventBuildingCollapsed:    "H",
	...
	events.EventGamblingLoss:         "x",
	events.EventGamblingResult:       "?",
	events.EventGenerationEnd:        "G",
	events.EventLastPersonAlive:      "1",
	events.EventCivilizationCollapse: "C",
	events.EventPopulationMilestone:  "B",
	events.EventEraChange:            "E",
	events.EventTeaching:             "T",
